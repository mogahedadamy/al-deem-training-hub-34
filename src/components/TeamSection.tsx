...
const TeamSection = () => {
  ...
  return <section id="team" className="py-12 md:py-16 bg-gradient-to-br from-background to-muted/20 relative overflow-hidden border-b border-primary/10">
      {/* Section Separator */}
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="text-center mb-8 md:mb-12 pt-8">
          ...
          <div className="mt-8 md:mt-12 animate-fade-in" style={{
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 animate-fade-in" style={{
        animationDelay: "0.3s"
      }}>
          {trainers.map((trainer, index) => <Card key={index} className="group border-0 shadow-card hover:shadow-elegant transition-all duration-500 hover:scale-105 bg-gradient-card overflow-hidden">
              <CardContent className="p-6 md:p-8">
                <div className="text-center">
                  {trainer.photo ? <div className="relative mb-6 mx-auto">
                      <div className="w-24 h-24 md:w-28 md:h-28 rounded-full overflow-hidden shadow-elegant group-hover:shadow-glow transition-all duration-300 mx-auto border-4 border-primary/20 group-hover:border-primary/40">
                        <img src={trainer.photo} alt={trainer.name} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300" />
                      </div>
                      {/* Badge overlay */}
                    ...
                    </div> : <div className={`bg-gradient-to-r ${trainer.gradient} p-4 rounded-2xl shadow-hover group-hover:shadow-glow transition-all duration-300 mb-6 mx-auto w-fit`}>
